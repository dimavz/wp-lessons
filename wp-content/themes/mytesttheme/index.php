...
//Используйте get_query_var('page')
// если нужно получить номер страницы пагинации статической главной страницы сайта — is_front_page().
// Переменная page в этом случае, содержит номер пагинации на страницах типа post,
// когда в контенте используется тег разбиения контента на страницы
$params = array(
